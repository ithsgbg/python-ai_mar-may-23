...
class QTrainer:
    ...
    def train_step(self, state, action, reward, next_state, done):
        ...
        # If we only have values for one step
        ...
        # 1. Predict the q_value with the current state
        ...
        loss.backward()  # Backpropagation, calculate all the gradients
        self.optimizer.step()  # Update all weights and biases in all neurons
